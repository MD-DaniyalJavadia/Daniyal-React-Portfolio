    ...
    return (
        <>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        {/* Certificate 4 */}
                         ...
                         <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card certificate-card h-100 clickable-card" data-bs-toggle="modal"
                                data-bs-target="#certificateModal4">
                                <div class="row g-0 align-items-center">
                                    <div class="col-4 certificate-img-wrapper">
                                        <img src="assets/images/Certificates/tesdomCsharp.png" class="img-fluid certificate-img"
                                            alt="C# and .NET TestDome Certificate" />
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body">
                                            <h5 class="card-title">C# and .NET</h5>
                                            <p class="card-text">
                                                C# and .NET Certificate – Completed from TestDome.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="certificateModal3" tabindex="-1" aria-labelledby="certificateModal3Label"
             ...
             {/* Modal 4 */}
            <div class="modal fade" id="certificateModal4" tabindex="-1" aria-labelledby="certificateModal4Label"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="certificateModal3Label">C# and .NET - TestDome</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body text-center">
                            <img src="assets/images/Certificates/tesdomCsharp.png" class="img-fluid"
                                alt="C# and .NET TestDome Certificate" />
                        </div>
                    </div>
                </div>
